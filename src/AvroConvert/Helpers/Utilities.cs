...
namespace Snappy.Sharp
{
    internal class Utilities
    {
        ...
        public static int NativeIntPtrSize()
        {
            unsafe
            {
        ...
        public static void UnalignedCopy64(byte[] source, int sourceIndex, byte[] dest, int destIndex)
        {
            unsafe
            {
        ...
        /// </summary>
        //[SecuritySafeCritical]
        public static uint GetFourBytes(byte[] source, int index)
        {
            unsafe
            {
        ...
        /// </summary>
        //[SecuritySafeCritical]
        public static ulong GetEightBytes(byte[] source, int index)
        {
            unsafe
            {
                Debug.Assert(index > -1);
        ...
        // Taken from Crc32.java in snappy-java project
        public static uint CalculateCrc(byte[] b, int off, int len)
        {
            uint localCrc = 0;
            while (len > 7)
            {
                uint c0 = b[off++] ^ localCrc;
                uint c1 = b[off++] ^ (localCrc >>= 8);
                uint c2 = b[off++] ^ (localCrc >>= 8);
                uint c3 = b[off++] ^ (localCrc >>= 8);
        ...
        static readonly uint[] T8_1 = new uint[]{
        ...
        static readonly uint[] T8_2 = new uint[]{
        ...
        static readonly uint[] T8_3 = new uint[]{
        ...
        static readonly uint[] T8_4 = new uint[]{
        ...
        static readonly uint[] T8_5 = new uint[]{
        ...
        static readonly uint[] T8_6 = new uint[]{
        ...
        static readonly uint[] T8_7 = new uint[]{

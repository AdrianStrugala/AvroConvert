...
namespace AvroConvert.TempSchema
{
    ...
    /// <summary>
    ///     Main interface that allows serialization of an object with generation support.
    /// </summary>
    internal interface IObjectSerializer
    {
        ...
        /// </returns>
        Expression BuildDeserializer(Expression decoder);
        ...
        /// <param name="decoder">The decoder.</param>
        /// <returns>
        /// Expression that skips the value using the given decoder.
        /// </returns>
        ...
        object Deserialize(IDecoder decoder);

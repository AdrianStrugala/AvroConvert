...
namespace SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.BuildSchema
{
    ...
    internal class IntSchema : PrimitiveTypeSchema
    {
        ...
        internal override global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type Type => global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Int;
    }
}

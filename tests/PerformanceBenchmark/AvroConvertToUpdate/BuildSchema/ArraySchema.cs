...
namespace SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.BuildSchema
{
    ...
    internal sealed class ArraySchema : TypeSchema
    {
        ...
        /// </summary>
        internal override global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type Type => global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Array;
    }
}
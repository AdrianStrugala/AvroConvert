...
In the first section, I will briefly introduce myself. Then I will describe the problem resolved in the article and compare Json and Avro formats. Finally, I will present the results of my benchmark and provide implementation details. 

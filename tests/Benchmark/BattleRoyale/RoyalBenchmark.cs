...
public partial class RoyalBenchmark
{
    ...
    public IEnumerable<DataSet> GenerateDataSets()
    {
        ...
        foreach (var set in sets)
        {
            ...
            BSON_Serialize(dataset);
            GroBuf_Serialize(dataset);
            NewtonsoftJson_Serialize(dataset);
            SystemTextJsonBrotli_Serialize(dataset);
            AvroConvertBrotli_Serialize(dataset);
            NewtonsoftJsonGzip_Serialize(dataset);
    ...
    public class SerializedData
    {
        ...
        public byte[] SystemTextJsonBrotli { get; set; }
        public byte[] NewtonsoftJsonGzip { get; set; }
        public byte[] AvroConvertBrotli { get; set; }
    }
}
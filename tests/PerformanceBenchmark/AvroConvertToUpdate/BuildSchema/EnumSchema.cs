...
namespace SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.BuildSchema
{
    ...
    internal sealed class EnumSchema : NamedSchema
    {
        ...
        internal override global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type Type { get; } = global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Enumeration;
    }
}

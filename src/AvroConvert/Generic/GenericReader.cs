...
namespace AvroConvert.Generic
{
    ...
    public sealed class GenericReader<T> : DatumReader<T>
    {
        ...
        public T Read(T reuse, IDecoder d)
        {
    ...
    public class DefaultReader
    {
        ...
        public object Read(object reuse, Schema writerSchema, Schema readerSchema, IDecoder d)
        {
        ...
        /// <param name="d">The IDecoder for deserialization</param>
        /// <returns></returns>
        ...
        /// <param name="dec">The IDecoder for deserialization</param>
        /// <returns>The record object just read</returns>
        protected virtual object ReadRecord(object reuse, RecordSchema writerSchema, Schema readerSchema, IDecoder dec)
        {
            ...
            var defaultIDecoder = new BinaryDecoder(defaultStream);
            foreach (Field rf in rs)
            {
                ...
                AddField(rec, rf.Name, rf.Pos, Read(obj, rf.Schema, rf.Schema, defaultIDecoder));
            }
        ...
        protected virtual object ReadEnum(object reuse, EnumSchema writerSchema, Schema readerSchema, IDecoder d)
        {
        ...
        protected virtual object ReadArray(object reuse, ArraySchema writerSchema, Schema readerSchema, IDecoder d)
        {
        ...
        /// <param name="readerSchema">The schema the reader is using.</param>
        /// <param name="d">The IDecoder for serialization.</param>
        /// <returns>The deserialized map object.</returns>
        protected virtual object ReadMap(object reuse, MapSchema writerSchema, Schema readerSchema, IDecoder d)
        {
        ...
        protected virtual object ReadUnion(object reuse, UnionSchema writerSchema, Schema readerSchema, IDecoder d)
        {
        ...
        protected virtual object ReadFixed(object reuse, FixedSchema writerSchema, Schema readerSchema, IDecoder d)
        {

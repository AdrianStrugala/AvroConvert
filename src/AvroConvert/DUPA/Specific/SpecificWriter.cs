...
namespace DUPA.Specific
{
    ...
    public class SpecificWriter<T> : GenericWriter
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpecificWriter{T}"/> class.
        /// </summary>
        /// <param name="schema">Schema to use when writing.</param>
        public SpecificWriter(Schema.Schema schema) : base(new SpecificDefaultWriter(schema)) { }
    ...
    public class SpecificDefaultWriter : DefaultWriter
    {
        ...
        public SpecificDefaultWriter(Schema.Schema schema) : base(schema) { }

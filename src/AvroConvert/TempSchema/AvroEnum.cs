...
namespace AvroConvert.TempSchema
{
    ...
    {
        private readonly TempSchema.EnumSchema schema;
        private int value;
        ...
        public AvroEnum(TempSchema.Schema schema)
        {
            this.schema = schema as TempSchema.EnumSchema;
            if (this.schema == null)
            {
        ...
        /// Gets the schema.
        /// </summary>
        public TempSchema.EnumSchema Schema
        {

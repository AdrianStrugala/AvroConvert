...
namespace V2.Reflect
{
    ...
    public class ReflectReader<T> : DatumReader<T>
    {
        ...
        /// </summary>
        public Schema.Schema WriterSchema { get => _reader.WriterSchema; }

        /// <summary>
        /// Schema for the reader class
        /// </summary>
        public Schema.Schema ReaderSchema { get => _reader.ReaderSchema; }
        ...
        public ReflectReader(Schema.Schema writerSchema, Schema.Schema readerSchema, ClassCache cache = null)
        {

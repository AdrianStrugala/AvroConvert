...
namespace DUPA.Generic
{
    ...
    public sealed class GenericReader<T> : DatumReader<T>
    {
        ...
        public GenericReader(Schema.Schema writerSchema, Schema.Schema readerSchema)
        ...
        /// </summary>
        public Schema.Schema WriterSchema { get { return reader.WriterSchema; } }

        /// <summary>
        /// Schema used to read the data.
        /// </summary>
        public Schema.Schema ReaderSchema { get { return reader.ReaderSchema; } }
        ...
        public T Read(Decoder d)
        {
            return reader.Read<T>(d);
        }
    }
    ...
    public class DefaultReader
    {
        ...
        /// </summary>
        public Schema.Schema ReaderSchema { get; private set; }

        /// <summary>
        /// Schema used to write data that we are reading with this reader.
        /// </summary>
        public Schema.Schema WriterSchema { get; private set; }
        ...
        /// <param name="writerSchema">The schema used while generating the data</param>
        /// <param name="readerSchema">The schema desired by the reader</param>
        public DefaultReader(Schema.Schema writerSchema, Schema.Schema readerSchema)
        {
        ...
        /// <param name="d">Decoder to read from.</param>
        /// <returns>Object read from the decoder.</returns>
        public object Read(object reuse, Schema.Schema writerSchema, Schema.Schema readerSchema, Decoder d)
        {
        ...
        /// <returns></returns>
        protected virtual object ReadNull(Schema.Schema readerSchema, Decoder d)
        {
            d.ReadNull();
            return null;
        }
        ...
        protected T Read<T>(Schema.Schema.Type tag, Schema.Schema readerSchema, Reader<T> reader)
        {
            return reader();
        }
        ...
        protected virtual object ReadRecord(object reuse, RecordSchema writerSchema, Schema.Schema readerSchema, Decoder dec)
        {
        ...
        protected virtual object ReadEnum(object reuse, EnumSchema writerSchema, Schema.Schema readerSchema, Decoder d)
        {
        ...
        protected virtual object ReadArray(object reuse, ArraySchema writerSchema, Schema.Schema readerSchema, Decoder d)
        {
        ...
        protected virtual object ReadMap(object reuse, MapSchema writerSchema, Schema.Schema readerSchema, Decoder d)
        {
        ...
        protected virtual object ReadUnion(object reuse, UnionSchema writerSchema, Schema.Schema readerSchema, Decoder d)
        {
        ...
        /// <param name="d">The decoder for serialization.</param>
        /// <returns>The deserialized object.</returns>
        protected virtual object ReadLogical(object reuse, LogicalSchema writerSchema, Schema.Schema readerSchema, Decoder d)
        {
        ...
        protected virtual object ReadFixed(object reuse, FixedSchema writerSchema, Schema.Schema readerSchema, Decoder d)
        {
        ...
        protected virtual void Skip(Schema.Schema writerSchema, Decoder d)
        {
            switch (writerSchema.Tag)
            {
                case Schema.Schema.Type.Null:
                ...
                case Schema.Schema.Type.Array:
                    {
                        Schema.Schema s = (writerSchema as ArraySchema).ItemSchema;
                ...
                case Schema.Schema.Type.Map:
                    {
                        Schema.Schema s = (writerSchema as MapSchema).ValueSchema;

...
namespace DUPA.Reflect
{
    ...
    public abstract class TypedFieldConverter<TAvro, TProperty> : IAvroFieldConverter
    {
        ...
        public abstract TProperty From(TAvro o, Schema.Schema s);
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public abstract TAvro To(TProperty o, Schema.Schema s);
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public object FromAvroType(object o, Schema.Schema s)
        {
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public object ToAvroType(object o, Schema.Schema s)
        {

...
namespace DUPA.Generic
{
    ...
    public class GenericWriter : DatumWriter
    {
        ...
        public GenericWriter(Schema.Schema schema) : this(new DefaultWriter(schema))
        {

        }

        /// <inheritdoc/>
        public Schema.Schema Schema { get { return writer.Schema; } }
    ...
    public class DefaultWriter
    {
        ...
        /// <param name="value">The value to be serialized</param>
        /// <param name="encoder">The encoder to use during serialization</param>
        public virtual void Write(Schema.Schema schema, object value, Encoder encoder)
        {
            switch (schema.Tag)
            {
                ...
                case DUPA.Schema.Schema.Type.Union:
                    ...
                    break;
                case DUPA.Schema.Schema.Type.Logical:
        ...
        protected virtual void Write<T>(object value, Schema.Schema.Type tag, Writer<T> writer)
        {
        ...
        protected virtual bool Matches(Schema.Schema sc, object obj)
        {
            if (obj == null && sc.Tag != DUPA.Schema.Schema.Type.Null) return false;
            switch (sc.Tag)
            {
                case DUPA.Schema.Schema.Type.Null:
                    return obj == null;

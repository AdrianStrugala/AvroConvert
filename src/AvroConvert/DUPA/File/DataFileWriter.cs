...
namespace DUPA.File
{
    ...
    public class DataFileWriter : IFileWriter
    {
        ...
        public static IFileWriter OpenWriter(DatumWriter writer, string path)
        {
        ...
        /// <returns>A new file writer.</returns>
//        public static IFileWriterOpenWriter(DatumWriter writer, Stream outStream)
//        {
...
//        }
        ...
        /// <returns>A new file writer.</returns>
        public static IFileWriter OpenWriter(DatumWriter writer, string path, Codec codec)
        {
        ...
        /// <param name="codec">Codec to use when writing.</param>
        /// <returns>A new file writer.</returns>
        public static IFileWriter OpenWriter(DatumWriter writer, Stream outStream, Codec codec)
        {
            return new DataFileWriter(writer).Create(writer.Schema, outStream, codec);
        }

        DataFileWriter(DatumWriter writer)
        {
            _writer = writer;
        ...
        private IFileWriter Create(Schema.Schema schema, Stream outStream, Codec codec)
        {
            _codec = codec;
            _stream = outStream;

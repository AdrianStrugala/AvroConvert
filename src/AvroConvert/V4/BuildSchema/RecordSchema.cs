...
using SolTechnology.Avro.V4.Attributes;
...
namespace SolTechnology.Avro.V4.BuildSchema
{
    ...
    internal sealed class RecordSchema : NamedSchema
    {
        ...
        internal override global::SolTechnology.Avro.V4.Schema.Schema.Type Type => global::SolTechnology.Avro.V4.Schema.Schema.Type.Record;
    }
}

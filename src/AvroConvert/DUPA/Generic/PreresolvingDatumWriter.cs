...
namespace DUPA.Generic
{
    ...
    public abstract class PreresolvingDatumWriter : DatumWriter
    {
        ...
        protected void Write<TValue>(object value, Schema.Schema.Type tag, Writer<TValue> writer)
        {
        ...
        /// <param name="value">The value to be serialized</param>
        /// <param name="encoder">The encoder for serialization</param>
        private void WriteUnion(UnionSchema unionSchema, Schema.Schema[] branchSchemas, WriteItem[] branchWriters, object value, Encoder encoder)
        {

...
namespace AvroConvert.TempSchema
{
    ...
    public sealed class AvroRecord : DynamicObject
    {
        ...
        private readonly TempSchema.RecordSchema schema;

        /// <summary>
        /// Initializes a new instance of the <see cref="AvroRecord"/> class.
        /// </summary>
        /// <param name="schema">The schema.</param>
        public AvroRecord(TempSchema.Schema schema)
        {
            this.schema = schema as TempSchema.RecordSchema;
            if (this.schema == null)
            {
        ...
        /// </summary>
        public TempSchema.RecordSchema Schema
        {
        ...
        private TempSchema.RecordField GetField(string fieldName)
        {
            RecordField field;

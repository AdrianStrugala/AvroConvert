...
using SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Attributes;

namespace SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.BuildSchema
{
    /// <summary>
    ...
    internal sealed class JsonSchemaBuilder
    {
        ...
        private TypeSchema ParseJsonObject(JObject token, NamedSchema parent, Dictionary<string, NamedSchema> namedSchemas)
        {
            ...
            {
                var type = token.RequiredProperty<global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type>(Token.Type);
                ...
                switch (type)
                {
                    case global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Record:
                        return this.ParseRecordType(token, parent, namedSchemas);
                    case global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Enumeration:
                        return this.ParseEnumType(token, parent, namedSchemas);
                    case global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Array:
                        return this.ParseArrayType(token, parent, namedSchemas);
                    case global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Map:
                        return this.ParseMapType(token, parent, namedSchemas);
                    case global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Fixed:
        ...
        private TypeSchema ParseUnionType(JArray unionToken, NamedSchema parent, Dictionary<string, NamedSchema> namedSchemas)
        {
            ...
            foreach (var typeAlternative in unionToken.Children())
            {
                ...
                if (schema.Type == global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Union)
                {
                    throw new SerializationException(

...
namespace SolTechnology.Avro.Util
{
    ...
    /// </summary>
    internal class TimestampMicrosecond : LogicalUnixEpochType<DateTime>
    {
        /// <summary>
        /// The logical type name for TimestampMicrosecond.
        /// </summary>
        internal static readonly string LogicalTypeName = "timestamp-micros";

        /// <summary>
        /// Initializes a new TimestampMicrosecond logical type.
        /// </summary>
        internal TimestampMicrosecond() : base(LogicalTypeName)
        { }

...
namespace DUPA.Generic
{
    ...
    public abstract class PreresolvingDatumReader<T> : DatumReader<T>
    {
        ...
        protected PreresolvingDatumReader(Schema.Schema writerSchema, Schema.Schema readerSchema)
        {
        ...
        /// </summary>
        private ReadItem ResolveReader(Schema.Schema writerSchema, Schema.Schema readerSchema)
        {
        ...
        private ReadItem ResolveUnion(UnionSchema writerSchema, Schema.Schema readerSchema)
        {
        ...
        private DecoderSkip GetSkip(Schema.Schema writerSchema)
        {
            switch (writerSchema.Tag)
            {
                case Schema.Schema.Type.Null:
        ...
        protected virtual bool IsReusable(Schema.Schema.Type tag)
        {
            return true;
        }
        ...
        {
            private Schema.Schema _writerSchema;
            private Schema.Schema _readerSchema;

            public SchemaPair( Schema.Schema writerSchema, Schema.Schema readerSchema )
            {

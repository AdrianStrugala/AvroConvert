...
namespace SolTechnology.Avro.Util
{
    ...
    /// </summary>
    internal class TimeMicrosecond : LogicalUnixEpochType<TimeSpan>
    {
        ...
        /// </summary>
        internal static readonly string LogicalTypeName = "time-micros";

        /// <summary>
        /// Initializes a new TimeMicrosecond logical type.
        /// </summary>
        internal TimeMicrosecond() : base(LogicalTypeName)
        { }

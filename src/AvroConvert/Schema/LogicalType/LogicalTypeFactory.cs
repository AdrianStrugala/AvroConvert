...
namespace SolTechnology.Avro.Util
{
    ...
    /// </summary>
    internal class LogicalTypeFactory
    {
        ...
        internal static LogicalTypeFactory Instance { get; } = new LogicalTypeFactory();
        ...
        internal void Register(LogicalType logicalType)
        {
        ...
        internal LogicalType GetFromLogicalSchema(LogicalSchema schema, bool ignoreInvalidOrUnknown = false)
        {
            try
            {

...
namespace DUPA.Reflect
{
    ...
    public class ReflectWriter : DatumWriter
    {
        /// <summary>
        /// Default writer
        /// </summary>
        ...
        public ReflectWriter(Schema.Schema schema, ClassCache cache = null)
            : this(new ReflectDefaultWriter(schema, cache))
        {
        }
        ...
        /// The schema
        /// </summary>
        public Schema.Schema Schema { get => _writer.Schema; }

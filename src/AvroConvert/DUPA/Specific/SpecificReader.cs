...
namespace DUPA.Specific
{
    ...
    public class SpecificReader<T> : DatumReader<T>
    {
        ...
        public SpecificReader(Schema.Schema writerSchema, Schema.Schema readerSchema)
        {
    ...
    public class SpecificDefaultReader : DefaultReader
    {
        ...
        public SpecificDefaultReader(Schema.Schema writerSchema, Schema.Schema readerSchema) : base(writerSchema,readerSchema)
        {
        }
        ...
        protected override object ReadRecord(object reuse, RecordSchema writerSchema, Schema.Schema readerSchema, Decoder dec)
        {
            ...
            ISpecificRecord rec = (reuse != null ? reuse : ObjectCreator.Instance.New(rs.Fullname, Schema.Schema.Type.Record)) as ISpecificRecord;
            object obj;
        ...
        protected override object ReadFixed(object reuse, FixedSchema writerSchema, Schema.Schema readerSchema, Decoder d)
        {
            ...
            SpecificFixed fixedrec = (reuse != null ? reuse : ObjectCreator.Instance.New(rs.Fullname, Schema.Schema.Type.Fixed)) as SpecificFixed;
        ...
        protected override object ReadEnum(object reuse, EnumSchema writerSchema, Schema.Schema readerSchema, Decoder dec)
        {
        ...
        protected override object ReadArray(object reuse, ArraySchema writerSchema, Schema.Schema readerSchema, Decoder dec)
        {
            ...
            if (reuse != null)
            {
                ...
                array = ObjectCreator.Instance.New(getTargetType(readerSchema), Schema.Schema.Type.Array) as System.Collections.IList;
        ...
        protected override object ReadMap(object reuse, MapSchema writerSchema, Schema.Schema readerSchema, Decoder d)
        {
            ...
            if (reuse != null)
            {
                ...
                map = ObjectCreator.Instance.New(getTargetType(readerSchema), Schema.Schema.Type.Map) as System.Collections.IDictionary;
        ...
        protected virtual string getTargetType(Schema.Schema schema)
        {
            bool nEnum = false;
            ...
            else if (schema.Tag == Schema.Schema.Type.Map)
            {

...
namespace V2.Reflect
{
    ...
    public class FuncFieldConverter<TAvro, TProperty> : TypedFieldConverter<TAvro, TProperty>
    {
        ...
        public FuncFieldConverter(Func<TAvro, Schema.Schema, TProperty> from, Func<TProperty, Schema.Schema, TAvro> to)
        {
            _from = from;
            _to = to;
        }

        private Func<TAvro, Schema.Schema, TProperty> _from;

        private Func<TProperty, Schema.Schema, TAvro> _to;
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public override TProperty From(TAvro o, Schema.Schema s)
        {
            return _from(o, s);
        }
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public override TAvro To(TProperty o, Schema.Schema s)
        {
            return _to(o, s);
        }
    }

...
namespace SolTechnology.Avro.Schema
{
    ...
    internal class LogicalSchema : UnnamedSchema
    {
        ...
        /// </summary>
        internal Schema BaseSchema { get; private set; }

        /// <summary>
        /// The logical type name.
        /// </summary>
        internal string LogicalTypeName { get; private set; }

        /// <summary>
        /// The logical type implementation that supports this logical type.
        /// </summary>
        internal LogicalType LogicalType { get; private set; }

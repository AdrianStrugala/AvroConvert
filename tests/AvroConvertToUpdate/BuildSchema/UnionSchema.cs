...
namespace SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.BuildSchema
{
    ...
    internal sealed class UnionSchema : TypeSchema
    {
        ...
        /// </summary>
        internal override global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type Type => global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Union;
    }
}

...
namespace SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.BuildSchema
{
    ...
    internal sealed class MapSchema : TypeSchema
    {
        ...
        /// </summary>
        internal override global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type Type => global::SolTechnology.PerformanceBenchmark.AvroConvertToUpdate.Schema.Schema.Type.Map;
    }
}

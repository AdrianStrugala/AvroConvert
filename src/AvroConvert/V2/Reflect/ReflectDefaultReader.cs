...
namespace V2.Reflect
{
    ...
    public class ReflectDefaultReader : SpecificDefaultReader
    {
        ...
        public ReflectDefaultReader(Type objType, Schema.Schema writerSchema, Schema.Schema readerSchema, ClassCache cache)
        ...
        /// <returns></returns>
        internal Type GetTypeFromSchema(Schema.Schema schema, bool nullable)
        {
            switch (schema.Tag)
            {
                ...
                case Schema.Schema.Type.Union:
                    ...
                    Schema.Schema nullibleType = CodeGen.CodeGen.getNullableType(unionSchema);
        ...
        /// <returns></returns>
        public object GetDefaultValue(Schema.Schema s, JToken defaultValue)
        {
        ...
        protected override object ReadEnum(object reuse, EnumSchema writerSchema, Schema.Schema readerSchema, Decoder d)
        {
            var i = d.ReadEnum();

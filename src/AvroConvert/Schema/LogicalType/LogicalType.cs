...
namespace SolTechnology.Avro.Util
{
    ...
    internal abstract class LogicalType
    {
        ...
        internal virtual void ValidateSchema(LogicalSchema schema)
        { }
        ...
        internal abstract object ConvertToBaseValue(object logicalValue, LogicalSchema schema);
        ...
        internal abstract object ConvertToLogicalValue(object baseValue, LogicalSchema schema);

...
namespace SolTechnology.Avro.Util
{
    ...
    /// </summary>
    internal class TimeMillisecond : LogicalUnixEpochType<TimeSpan>
    {
        ...
        /// </summary>
        internal static readonly string LogicalTypeName = "time-millis";

        /// <summary>
        /// Initializes a new TimeMillisecond logical type.
        /// </summary>
        internal TimeMillisecond() : base(LogicalTypeName)
        { }

        /// <inheritdoc/>
        internal override void ValidateSchema(LogicalSchema schema)
        {
            if (Schema.Schema.Type.Int != schema.BaseSchema.Tag)
